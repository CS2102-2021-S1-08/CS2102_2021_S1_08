...
CREATE FUNCTION add_successful_bid_to_monthly_summary() RETURNS TRIGGER LANGUAGE PLPGSQL AS $$
...
UPDATE ON bids FOR EACH ROW
	WHEN (NEW.is_successful = TRUE) EXECUTE PROCEDURE add_successful_bid_to_monthly_summary();
--- Leaves
